...
export default function Nav({ isShowNav }) {
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full h-full bg-bgGray transition-all md:static md:h-auto md:w-auto z-50"
      }
    >
          ...
          <nav className="flex flex-col gap-2">
            ...
            >
              <svg
                ...
                stroke="currentColor"
                className={
                  pathname === "/categories" ? activeIcon : inactiveIcon
                }
              >
                <path
                  strokeLinecap="round"
